...
const authModal = (props) => {
    ...
    const OverLay = (props) => {
        return (
            <div className={`authModal ${authState.signUp?"top-[10vh]":"top-[5vh]"}  sm:top-0 relative   sm:pb-10 p-4 sm:px-0 sm:pt-0  w-[70rem] max-w-[90%] bg-white rounded shadow-lg z-30`}>
