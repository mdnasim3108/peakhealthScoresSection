...
const GetStarted = (props) => {
  ...
  return (
    <div>
      <h1 className="font-bold mb-5 md:text-4xl text-2xl  text-center">What’s my Work Stress level?</h1>
      <h2 className="md:text-xl sm:text-lg text-gray-500 relative bottom-5 text-center">
      ...
      <div className="flex flex-col md:flex-row justify-around items-center">
        ...
        <div className="flex flex-col items-center">
          <p className="font-sans text-lg mb-5 text-center sm:w-max">
            Don't let job stress control you - take control today!
          </p>
          <button
            className=" border w-max border-violet-500 bg-violet-500 hover:bg-violet-600 text-white font-bold sm:px-8 sm:py-3 px-4 py-2 rounded outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
