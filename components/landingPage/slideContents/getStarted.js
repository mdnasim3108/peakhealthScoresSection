...
const GetStarted = (props) => {
  ...
  return (
    <div className="" ref={nodeRef}>
      ...
      <div className="flex flex-col sm:w-full md:flex-row justify-around items-center">
        <div className="flex sm:w-[50%] flex-col items-center">
          <Image
            src={getStartImage}
        ...
        <div className="flex sm:w-[50%] flex-col items-center justify-start">
          <Image
            ...
            alt="getStart"
          />
          <p className="font-sans text-xl mb-5 text-center sm:w-[90%] text-gray-500">
          ...
          <button
            id="startingButton"
            className=" border border-[#3F4FDB] tracking-wide text-lg hover:bg-[#3F4FDB] bg-[#3F4FDB] text-white hover:text-white   font-bold sm:px-8 sm:py-3 px-4 py-2 rounded outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
            onClick={() => {
              props.move()
            }}
          >
          ...
          <button
            className="border lg:hidden block mt-4 tracking-wide text-lg bg-[#3F4FDB] border-[#3F4FDB] text-white  hover:bg-[#3F4FDB]  font-bold sm:px-[3.9rem] sm:py-3 px-4 py-2 rounded outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
