...
const Navigation = (props) => {
    ...
    return <div className="h-full w-full py-[1rem] pl-[5rem] pr-[10rem] flex flex-col justify-around">

        <BotMessage message="Good evening" />

        <div className="w-[90%] mt-3 grid grid-cols-2 gap-4">

            <div className="w-[375px] h-[20vh] bg-white border-2 rounded-2 p-3 flex items-start hover:shadow-xl hover:z-10  transition-all duration-150 ease-in-out cursor-pointer"
            ...
            <div className="w-[375px] h-[20vh] bg-white border-2 rounded-2 p-3 flex flex-col justify-between">
            ...
            <div className="w-[375px] h-[20vh] bg-white border-2 rounded-2 p-3 flex items-start hover:shadow-xl   transition-all duration-150 ease-in-out cursor-pointer">
            ...
            <div className="w-[375px] h-[20vh] bg-white border-2 rounded-2 p-3">
                ...
                <div className="flex">
                    ...
                    {/* <div className="w-[160px] h-[75px] border-[15px] border-b-0" style={{ borderRadius: "150px 150px 0 0" }}>
